...
<template>
    ...
    <div :class="{ 'active': message.active }"
        class="message-box border border-gray-200 fixed bottom-5 right-5 bg-white rounded-lg w-fit max-w-[500px] min-w-[200px] shadow-lg p-5 flex justify-between items-center gap-3">
